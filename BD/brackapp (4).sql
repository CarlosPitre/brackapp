...
--
-- Servidor: localhost
-- Tiempo de generación: 26-07-2016 a las 10:01:40
...
CREATE TABLE IF NOT EXISTS `imagenesProfesionalProducto` (
  `id` int(11) NOT NULL,
...
(1, 'Carlos Pitre', '1065654572', '10.4820084', '-73.2750313', '../img/negro.jpg', 'carlosjpitre@gmail.com', '3004706152', 'Ingeniero de Sistemas', 'Activo', 'Desarrollador Brackapp', 2, 2, 'Activo', 2),
...
INSERT INTO `solicitud` (`id`, `fecha`, `idCliente`, `idProfesional`, `idProducto`, `idServicio`) VALUES
(1, '2016-07-01 15:46:05', 1, 2, NULL, 1);
...
(1, 'user', '12dea96fec20593566ab75692c9949596833adc9', 2, 1);
