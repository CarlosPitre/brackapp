...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-08-2016 a las 18:01:08
...
(1, 'Luis Serge', '1065654572', '10.4820084', '-73.2750313', '../img/negro.jpg', 'carlosjpitre@gmail.com', '3004706152', 'Ingeniero de Sistemas', 'Activo', 'Desarrollador Brackapp', 2, 2, 'Activo', 2),
...
(2, 2, 1, 2, 57, 'Disponible', 'Activo'),
(5, 1, 2, 2, 55, 'Disponible', 'Activo'),
(6, 1, 6, 5, 17, 'Disponible', 'Activo');
...
INSERT INTO `servicio` (`id`, `descripcion`, `estado`) VALUES
(1, 'Mantenimiento de Computadores', 'Activo'),
(2, 'Pulidora', 'Activo');
...
(1, '2016-08-08 16:21:35', 1, 1, 1, 1, 3);
